...
parser = argparse.ArgumentParser("sKMNIST")
...
def main():
  ...
  for index,arch in enumerate(archs):
    ...
    # modify the genotype parameter here
    #print('infer arch %d'%arch)
    model = NetworkMNIST(args.init_channels, CIFAR_CLASSES, args.layers, args.auxiliary, genos[index])
    model_path="models/sKMNIST/"+str(arch)+".pt"
  ...
  # strategy 1: ensemble by simple soft voting
